...
import nuc.jyg.knowing.async.EventProducer;
import nuc.jyg.knowing.async.EventType;
import nuc.jyg.knowing.model.*;
import nuc.jyg.knowing.service.*;
...
public class FollowController {
    ...
    public void doHandle(int ownerId, int actorId) {
        ...
        message.setContent("用户" + user.getName()
                + "关注了你,http://127.0.0.1:8080/user/" + actorId);
    ...
    public String followUser(@RequestParam("userId") int userId) {
        ...
        /*eventProducer.fireEvent(new EventModel(EventType.FOLLOW)
                .setActorId(2).setEntityId(1)
                .setEntityType(EntityType.ENTITY_USER).setEntityOwnerId(1));*/
//        doHandle(1, 2);
//        return "";
